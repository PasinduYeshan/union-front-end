  ...
  return (
    <>
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
          <div className="w-full lg:w-6/12">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 text-justify">
              Union of Posts & Telecommunication Officers or UPTO is governed
              according to the constitution of its own which passed at the
              Annual General Meeting by the majority of membership. We observe,
              in time to time the amendments were done with current day needs.
              The governing body or Council of Management consists of 58 elected
              members including branch secretaries.
            </p>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 text-justify">
              The committee elected at the Annual Conference of Delegates
              conducts each year. For easy administration the union has
              established 27 branches to cover entire country. At present the
              union is march forward under the leadership of Brother
              H.K.kariyawasam, Hon. General Secretary and Brother Shantha Kumara
              Meegama, president. Brother. Harindra Weliwita serves as Hon.
              Treasurer
            </p>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 text-justify">
              At present membership is over 4000 under 27 branches.
            </p>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 text-justify">
              Union of Posts & Telecommunication Officers or popularly known as
              UPTO is one of the gigantic long standing trade unions in our
              country which links to Union Network International (UNI) a
              recognized world trade union body and owns five stories building
              at the heart of Colombo city.
            </p>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 text-justify">
              Our first trade union action was in 1947 to force the
              administration to re-instate then Hon. General Secretary Bro.
              A.Sampanthan indicted due to taking part at trade union rally
              organized by clerical union.
            </p>
          </div>
          <div className="w-full lg:w-6/12">
            <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
        ...
        <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
          <div>
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              ...
              quis metus blandit, molestie nisl convallis, pellentesque nulla.
              Sed eleifend, ligula ac tempus fringilla, magna metus accumsan
              sem, non finibus dolor tellus eget purus. Donec nulla ante,
              interdum eu eros vitae, tristique accumsan ante. Integer odio
              urna, placerat ac elit eget, consectetur ultricies risus.
            </p>
          </div>
          <div>
            <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">
        ...
        <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16 align-middle">
          <div className="w-full lg:w-6/12">
